...
import br.edu.puc.toothnow.databinding.ActivityMainBinding
import br.edu.puc.toothnow.datastore.UserPreferencesRepository
...
class MainActivity: AppCompatActivity() {
    ...
    private fun prepareFirebaseAppCheckDebug(){
        //Ajustando AppCheck para depuracao
